...
internal class LoginViewModelTest : BaseUiTest() {
    ...
    fun test_empty_email_valid_password() {
        ...
        assertThat(LoginState.LoginError(value = "Input is empty")).isEqualTo(
            communication.state()
        )
    }
    ...
    fun test_invalid_email_valid_password() {
        ...
        assertThat(LoginState.LoginError(value = "Email is incorrect")).isEqualTo(
            communication.state()
        )
    }
    ...
    fun test_valid_email() {
        ...
        assertThat(LoginState.PasswordError(value = "Input is empty")).isEqualTo(
            communication.state()
        )
    }
